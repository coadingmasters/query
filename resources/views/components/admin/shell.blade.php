...
@php
    $navItems = [
        ...
        ['key' => 'search-console', 'label' => 'Search Console', 'href' => route('admin.search-console'), 'icon' => 'M11 19a8 8 0 1 0 0-16 8 8 0 0 0 0 16Zm10 2-4.35-4.35'],
        ...
        ['key' => 'media', 'label' => 'Media', 'href' => route('admin.media.index'), 'icon' => 'M4 5h16a1 1 0 0 1 1 1v12a1 1 0 0 1-1 1H4a1 1 0 0 1-1-1V6a1 1 0 0 1 1-1Z M4 16l4.5-5 3.5 3.5 2.5-3 5.5 5.5 M8.2 9.5a1.3 1.3 0 1 0 0-2.6 1.3 1.3 0 0 0 0 2.6Z'],
        ['key' => 'videos', 'label' => 'Videos', 'href' => route('admin.videos.index'), 'icon' => 'M4 5h16a1 1 0 0 1 1 1v12a1 1 0 0 1-1 1H4a1 1 0 0 1-1-1V6a1 1 0 0 1 1-1Z M10 9.5v5l4.5-2.5-4.5-2.5Z'],
        ...
        ['key' => 'visitors', 'label' => 'Visitors', 'href' => route('admin.visitors.index'), 'icon' => 'M12 21c-4.97-4-9-7.58-9-11.5A5.5 5.5 0 0 1 12 6a5.5 5.5 0 0 1 9 3.5C21 13.42 16.97 17 12 21Z M12 12a2.5 2.5 0 1 0 0-5 2.5 2.5 0 0 0 0 5Z'],
        ['key' => 'redirects', 'label' => 'Redirects', 'href' => route('admin.redirects.index'), 'icon' => 'M17 8V4m0 0h-4m4 0-6 6M7 16v4m0 0h4m-4 0 6-6'],
        ...
        <header class="sticky top-0 z-30 flex items-center justify-between gap-4 border-b border-line bg-surface-soft/95 px-4 py-3.5 backdrop-blur sm:px-6">
            <div class="flex items-center gap-3">
                <button type="button" x-on:click="sidebarOpen = true" aria-label="Open menu"
                        class="-ml-1 flex size-9 items-center justify-center rounded-lg text-ink-muted transition hover:bg-surface lg:hidden">
            ...
            <div class="relative" x-data="{ open: false }">
                <button type="button" x-on:click="open = !open" x-bind:aria-expanded="open" aria-haspopup="true"
                        class="flex items-center gap-2.5 rounded-xl py-1.5 pr-1 pl-2.5 transition hover:bg-surface">
                    <span class="hidden text-right sm:block">
                        <span class="block text-sm font-semibold text-ink">{{ auth()->user()->name }}</span>
                    ...
                    <svg class="hidden size-4 shrink-0 text-ink-muted transition sm:block" x-bind:class="open && 'rotate-180'"
