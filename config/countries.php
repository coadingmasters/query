...
// ISO 3166-1 alpha-2 code to English short name. Used to turn the country
// codes in the imported GeoIP dataset (ip_ranges) into a name for display —
// avoids depending on the intl extension, which isn't guaranteed to be
