...
return [
    ...
    'can-cats-eat-broccoli' => [
        ...
        'faq' => [
            [
                'q' => 'Can cats eat broccoli?',
                'a' => 'Yes, in small amounts. Plain, cooked broccoli is not toxic to cats and most tolerate a floret or two without any problem. It offers cats little nutritionally, since they are obligate carnivores and get what they need from meat, so it is worth thinking of as an occasional extra rather than a healthy addition.',
            ],
            [
                'q' => 'Is it okay to give my cat broccoli every day?',
                'a' => 'Better as an occasional thing than a daily habit. Cruciferous vegetables like broccoli contain compounds that can cause gas or an upset stomach in larger or more frequent amounts, and there is no nutritional reason a cat needs it regularly.',
            ],
            [
                'q' => 'Can cats eat raw broccoli?',
                'a' => 'Small, soft pieces of raw floret are usually fine, but the stalk is fibrous and much harder to chew and digest raw. Cooking it plain, until soft, is the safer choice, particularly for the stalk, which is also the part most likely to be swallowed in a piece too large to pass easily.',
            ],
            [
                'q' => 'Can kittens eat broccoli?',
                'a' => 'There is no specific reason kittens cannot have a very small taste of plain cooked broccoli, but their growing bodies need calorie-dense, complete kitten food far more than an adult cat does, so it makes even less sense as a regular addition for a kitten than for an adult.',
            ],
            [
                'q' => 'What vegetables are toxic to cats?',
                'a' => 'Onion, garlic, chives and leeks are the ones that actually matter, and they are genuinely dangerous even in small, cooked amounts. Broccoli is not in that category. Our full breakdown of what is safe, what needs care and what to avoid entirely covers all of them by category.',
            ],
            [
                'q' => 'Why does my cat ignore the broccoli I offer?',
                'a' => 'Completely normal. Cats lack the taste receptors for sweetness that make plant matter appealing to many other animals, and most show little to no interest in vegetables at all. A cat walking away from broccoli is not doing anything wrong.',
            ],
            [
                'q' => 'My cat ate a whole piece of broccoli stalk. Should I worry?',
                'a' => 'Watch for coughing, gagging, drooling or repeated swallowing in the minutes after, which can signal something caught in the throat, and for vomiting or reduced appetite over the following day, which can signal a partial blockage. Either warrants a call to your vet rather than waiting it out.',
            ],
        ],
        'sources' => [
            [
                'name' => 'Cornell Feline Health Center: feeding your cat',
                'url' => 'https://www.vet.cornell.edu/departments-centers-and-institutes/cornell-feline-health-center/health-information/feeding',
                'note' => 'Background on what a cat\'s diet actually needs to provide, and where extras like vegetables fit in.',
            ],
            [
                'name' => 'WSAVA Global Nutrition Guidelines',
                'url' => 'https://wsava.org/global-guidelines/global-nutrition-guidelines/',
                'note' => 'The nutritional assessment framework vets use, and why an obligate carnivore\'s diet centers on meat.',
            ],
            [
                'name' => 'ASPCA: cat health and wellness',
                'url' => 'https://www.aspca.org/pet-care/cat-care',
                'note' => 'General guidance on safe and unsafe foods for cats.',
            ],
        ],
        'related_tools' => ['cat-age-calculator'],
        'related_posts' => ['can-cats-eat-chicken', 'how-much-should-i-feed-my-cat'],
    ],
    ...
    'best-food-for-indoor-cats' => [
        ...
        'faq' => [
            ...
            [
                'q' => 'How many calories does an indoor cat need?',
                'a' => 'Less than an equivalent outdoor cat, generally, because there is less activity to burn through. Our guide to how much to feed a cat has a reference table and the formula vets actually use, starting from body weight rather than a life-stage label.',
            ],
            [
                'q' => 'Do I need a hairball control formula?',
                'a' => 'Only if hairballs are actually a recurring issue for your cat. Regular brushing does more for most cats than a specialised food, and a cat bringing up hairballs more than occasionally, or straining without producing one, is worth mentioning to a vet rather than solving with a bag swap alone.',
            ],
            [
                'q' => 'Can an indoor cat just eat the same food as an outdoor cat?',
                'a' => 'Yes, as long as the calories are right for how active that specific cat actually is. Life stage and portion size matter more than an indoor or outdoor label on the packaging, and the same complete, balanced adult formula works for both if the amount is adjusted to fit.',
            ],
        ],
        'sources' => [
            [
                'name' => 'Cornell Feline Health Center: feeding your cat',
                'url' => 'https://www.vet.cornell.edu/departments-centers-and-institutes/cornell-feline-health-center/health-information/feeding',
                'note' => 'What a complete and balanced diet needs to provide, regardless of indoor or outdoor lifestyle.',
            ],
            [
                'name' => 'WSAVA Global Nutrition Guidelines',
                'url' => 'https://wsava.org/global-guidelines/global-nutrition-guidelines/',
                'note' => 'The nutritional assessment framework used to build an individual feeding plan.',
            ],
            [
                'name' => 'ASPCA: cat health and wellness',
                'url' => 'https://www.aspca.org/pet-care/cat-care',
                'note' => 'General guidance on feeding and weight in cats.',
            ],
        ],
        'related_tools' => ['cat-age-calculator'],
        'related_posts' => ['how-much-should-i-feed-my-cat', 'signs-your-cat-is-sick'],
    ],
    ...
    'can-cats-eat-chicken' => [
        ...
        'faq' => [
            [
                ...
                'a' => 'Yes, and it is one of the better things you can offer. Chicken is a lean, easily digested protein that already appears in most commercial cat foods, so a cat eating plain cooked chicken is eating something close to what is already in their bowl.',
            ],
            [
                'q' => 'Can cats eat chicken bones?',
                'a' => 'No. Cooked bones become brittle and can splinter into sharp fragments that cause choking or injure the throat, stomach or intestines on the way through. Always remove every bone before offering chicken to a cat, and check the piece over rather than trusting that you got them all.',
            ],
            [
                'q' => 'Can cats eat chicken skin?',
                'a' => 'Best kept to a minimum. Chicken skin is high in fat, and a cat eating a lot of it, especially seasoned or fried skin, is more likely to get an upset stomach, and repeated fatty extras are a recognized risk factor for pancreatitis in cats. A small amount now and then is unlikely to cause harm; a habit of it is worth dropping.',
            ],
            [
                'q' => 'Can cats eat raw chicken?',
                'a' => 'The concern with raw chicken is not the chicken itself but bacteria like salmonella and campylobacter, which can make a cat unwell and can also spread to people handling the food and the litter tray afterward. Cooking it removes that risk, which is why cooked, plain chicken is the safer default.',
            ],
            [
                'q' => 'Can I feed my cat only chicken?',
                'a' => 'No. Plain chicken is not a complete diet on its own; it is missing taurine at the right level, calcium, and other nutrients a properly formulated cat food balances. Chicken works well as a topper or an occasional addition alongside a complete diet, not as a replacement for one.',
            ],
            [
                'q' => 'Can cats be allergic to chicken?',
                'a' => 'Yes, and chicken is actually one of the more common food sensitivities in cats, alongside fish and beef. Signs include itchy skin, ear infections or digestive upset that shows up consistently after eating it. A vet can help confirm a food allergy rather than guessing from one bad reaction.',
            ],
            [
                'q' => 'How much chicken can I give my cat?',
                'a' => 'A few small, bite-sized pieces now and then is plenty. Treats and extras, chicken included, are generally kept under about ten percent of a cat\'s daily calories, which our feeding guide covers alongside how to work out your own cat\'s daily total.',
            ],
        ],
        'sources' => [
            [
                'name' => 'Cornell Feline Health Center: feeding your cat',
                'url' => 'https://www.vet.cornell.edu/departments-centers-and-institutes/cornell-feline-health-center/health-information/feeding',
                'note' => 'Background on protein sources and what a complete feline diet needs beyond meat alone.',
            ],
            [
                'name' => 'WSAVA Global Nutrition Guidelines',
                'url' => 'https://wsava.org/global-guidelines/global-nutrition-guidelines/',
                'note' => 'The nutritional framework behind why a whole-food addition cannot replace a formulated diet.',
            ],
            [
                'name' => 'ASPCA: cat health and wellness',
                'url' => 'https://www.aspca.org/pet-care/cat-care',
                'note' => 'General guidance on safe foods and portioning for cats.',
            ],
        ],
        'related_tools' => ['cat-age-calculator'],
        'related_posts' => ['can-cats-eat-broccoli', 'how-much-should-i-feed-my-cat'],
    ],
    ...
    'new-cat-owner-guide' => [
        ...
        'faq' => [
            [
                'q' => 'What do I need to buy before bringing a cat home?',
                'a' => 'The essentials: a litter box and litter, food and water bowls, a carrier, a scratching post, a bed, and a few toys. Everything else, including a particular food brand or a second scratching post, can wait until you know your cat\'s preferences rather than guessing them in advance.',
            ],
            [
                'q' => 'How do I help a new cat settle in?',
            ...
            [
                'q' => 'When should I take a new cat to the vet?',
                'a' => 'Within the first week if possible, even if they seem completely healthy. A first visit establishes a baseline, confirms vaccination and parasite prevention are up to date or gets them started, and is the right time to discuss microchipping and spay or neuter timing if that has not already been done.',
            ],
            [
                'q' => 'What plants are toxic to cats?',
                'a' => 'Lilies are the one to know above all others: every part of the plant, including pollen and the water in a vase, is highly toxic to cats and can cause fatal kidney failure from a small exposure. If you keep any lilies in the house, they need to come out before a cat moves in, not after.',
            ],
            [
                'q' => 'How many litter boxes do I need?',
                'a' => 'The usual guidance is one box per cat, plus one extra, placed in quiet, easily accessible spots away from food and water. For a single new cat, that means two boxes is a safer starting point than one, particularly while they are still learning the house.',
            ],
            [
                'q' => 'How long does it take for a cat to adjust to a new home?',
                'a' => 'Anywhere from a few days to a few weeks, and it varies a lot by individual cat and by how they came to you. Hiding, reduced appetite and low activity in the first days are normal; if any of those continue much past a week or two, or your cat stops eating entirely, it is worth a call to the vet rather than assuming it will pass.',
            ],
            [
                'q' => 'When can I introduce my new cat to other pets?',
                'a' => 'Slowly, and only once the new cat is comfortable in their own space. A gradual introduction through a closed door, then supervised, brief visits, over a week or more, goes better than a first meeting with no barrier. Rushing this step is one of the more common causes of lasting tension between cats.',
            ],
        ],
        'sources' => [
            [
                'name' => 'Cornell Feline Health Center',
                'url' => 'https://www.vet.cornell.edu/departments-centers-and-institutes/cornell-feline-health-center',
                'note' => 'Background on kitten and new-cat care, vaccination and general feline health.',
            ],
            [
                'name' => 'ASPCA: cat health and wellness',
                'url' => 'https://www.aspca.org/pet-care/cat-care',
                'note' => 'General guidance on settling a new cat in and household hazards, including toxic plants.',
            ],
            [
                'name' => 'WSAVA Global Nutrition Guidelines',
                'url' => 'https://wsava.org/global-guidelines/global-nutrition-guidelines/',
                'note' => 'The feeding framework referenced when setting up a new cat\'s diet.',
            ],
        ],
        'related_tools' => ['cat-age-calculator'],
        'related_posts' => ['signs-your-cat-is-sick', 'how-much-should-i-feed-my-cat', 'why-do-cats-knead'],
    ],
