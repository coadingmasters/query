...
| phrases people search — "cat pregnancy week by week", "when do cats show
| signs of pregnancy" — are in it. Content that only exists inside a script
...
return [
    ...
    [
        'week' => 6,
        'title' => 'Movement',
        'what_happens' => 'The kittens measure around 3cm and are recognisably '
    ...
    [
        ...
        'visible_signs' => 'She becomes less active and starts looking for quiet, '
            .'enclosed places — under beds, in wardrobes, at the back of cupboards.',
        'care_tips' => [
    ...
    [
        ...
        'care_tips' => [
            'Keep the nesting box ready and the house calm — a stressed cat can delay labour.',
    ...
    [
        ...
        'visible_signs' => 'Active nesting, restlessness and pacing. Many cats stop '
            .'eating in the final day. A drop in body temperature below 37.8°C '
            .'usually means labour within about 24 hours.',
        'care_tips' => [
            'Leave her alone in the nesting box unless something is wrong — watching too closely can stall labour.',
